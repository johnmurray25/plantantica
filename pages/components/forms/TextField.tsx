    ...
    ({ onChange, textarea = false, ...props }, ref) => {
        ...
        return (
            <div>
                <InputElement
                    ref={ref as any}
                    className={`text-right border border-r-1 border-b-0  border-gray-600 border-opacity-40 text-${props.color || 'lime-50'} bg-secondaryDark bg-opacity-80 rounded-xl  
                                p-3 mb-3  
