...
const NavBar2 = () => {
    ...
    return (
        <div className='futura flex justify-between items-center px-4 py-4'>
            {/* Left */}
            <Link href="/" passHref>
                <div className="futura font-bold text-gray-50 hover:text-green-300 transition-colors text-3xl flex items-center flex-shrink-0  cursor-pointer med:pr-4 py-1 px-2 ">
            ...
            {width >= 800 ?
                    ...
                    {isLoading ?
                        ...
                        dBUser ?
                            <Link href="/profile" passHref>
                                <div className='ml-8 text-gray-100 text-opacity-80 transition-colors hover:bg-green-700 flex items-center rounded-full justify-between cursor-pointer lg:mr-8 bg-gray-100 bg-opacity-70 shadow-md p-0.5'>
                                    {
                                        profPicUrl ?
                ...
                <div>
                    ...
                    <div className={`fixed h-screen w-4/5 top-0 right-0 z-50 text-xl px-8 pt-6
                        ${showSidebar ? 'translate-x-0' : 'translate-x-full'} ease-in-out duration-200 bg-gray-900 bg-opacity-70 backdrop-blur text-gray-100 text-opacity-70`}>
